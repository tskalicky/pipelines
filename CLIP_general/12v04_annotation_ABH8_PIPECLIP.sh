...
ABH8_PIPECLIP="/storage/brno3-cerit/home/tskalicky/ABH8/peak_calling/Galaxy5-PIPE-CLIP_ABH8_n20/ABH8_CLIP_enrichedClusters_n20.bed"
...
cp -av $ABH8_PIPECLIP $SCRATCHDIR
