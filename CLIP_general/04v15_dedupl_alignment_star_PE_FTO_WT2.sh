...
#PBS -j oe
#PBS -N 04v15_alignment_PE_FTO_WT2
#
...
INPUT_DIR=/storage/brno3-cerit/home/tskalicky/FTO/preprocessed/data/FTO_WT2_job_4257007_arien
OUTPUT_DIR=/storage/brno3-cerit/home/tskalicky/FTO/mapping/deduplicated/WT2
...
APPENDIX6="_R1.dedupl.fastq.gz"
APPENDIX7="_R2.dedupl.fastq.gz"
...
RD_LENGTH=124 # Read length from the sequencing. Illumina sometimes reports N+1 http://seqanswers.com/forums/archive/index.php/t-31154.html; in case you change this value uncomment next line as well
...
GENOME_INDEX="/storage/brno3-cerit/home/tskalicky/genomes/human/ensembl91/STAR_index/Homo_sapiens.GRCh38.dna.primary_assembly_RD_LENGTH_124" # Genome index with --sjdbOverhang 124 - Only for FTO WT and INPUT with libs. length=125
...
cp -av $MY_GENOME $MY_GTF $INPUT_DIR/*$APPENDIX1 $INPUT_DIR/*$APPENDIX2 $SCRATCHDIR
...
# wait
wait
rm $SCRATCHDIR/*_R1.fastq $SCRATCHDIR/*_R2.fastq # deleting original data
#####################################################################################################
