...
#PBS -j oe
#PBS -N 04v15_alignment_PE_FTO_WT3
#
...
INPUT_DIR=/storage/brno3-cerit/home/tskalicky/FTO/mapping/deduplicated/WT3/results
OUTPUT_DIR=/storage/brno3-cerit/home/tskalicky/FTO/mapping/deduplicated/WT3
...
cp -av $MY_GENOME $MY_GTF $INPUT_DIR/*$APPENDIX6 $INPUT_DIR/*$APPENDIX7 $SCRATCHDIR
