...
#PBS -j oe
#PBS -N 05v063_FTO_CLIP_Collapsing_PCR_duplicates
#
...
############################################################################################
### Variables
INPUT_DIR="/storage/brno3-cerit/home/tskalicky/FTO/mapping/deduplicated/FTO_CLIP/results/alignment/genome"
...
OUTPUT_DIR="/storage/brno3-cerit/home/tskalicky/FTO/mapping/deduplicated/FTO_CLIP/PCR_collapsed-genome"
...
do
	...
	ls -c1 *.tag.uniq.bed
	# Keep track what proportion of unique tags.
	wc -l $SCRATCHDIR/BED/*.tag.uniq.bed > Unique_tags_numbers.txt
	echo "Statistics of proportions of unique tags stored in file:"
	ls -c1 *proportions.txt
