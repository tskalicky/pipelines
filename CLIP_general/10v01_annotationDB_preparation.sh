...
GeneCodeDB="$HOME/ownCloud/CEITEC_lab/genomes/annotationDB/gencode/gencode.v27.annotation.gtf.gz"
tRNA_ANNOT="$HOME/ownCloud/CEITEC_lab/genomes/annotationDB/gencode/gencode.v27.tRNAs.gtf.gz"
OUTPUT="$HOME/ownCloud/CEITEC_lab/genomes/annotation/my_annot_DB"
...
# $MERGEBED -c 4,5,6 -o distinct,distinct,distinct -i stdin > GRCh38.91.mRNA_exons.merged.sorted.bed
#
