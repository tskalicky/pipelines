...
#PBS -j oe
#PBS -N 05v064_FTO_Input_Collapsing_PCR_duplicates
#
...
############################################################################################
### Variables
INPUT_DIR="/storage/brno3-cerit/home/tskalicky/FTO/mapping/deduplicated/FTO_Input/results/alignment/genome"
...
OUTPUT_DIR="/storage/brno3-cerit/home/tskalicky/FTO/mapping/deduplicated/PCR_collapsed-genome/FTO_Input"
