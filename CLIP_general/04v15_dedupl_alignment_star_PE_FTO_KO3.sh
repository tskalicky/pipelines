...
#PBS -l select=1:ncpus=10:mem=100gb:scratch_local=250gb
#PBS -j oe
#PBS -N 04v15_alignment_PE_FTO_KO3
#
...
INPUT_DIR=/storage/brno3-cerit/home/tskalicky/FTO/preprocessed/data/FTO_KO3_job_4255583_arien
OUTPUT_DIR=/storage/brno3-cerit/home/tskalicky/FTO/mapping/deduplicated/KO3
