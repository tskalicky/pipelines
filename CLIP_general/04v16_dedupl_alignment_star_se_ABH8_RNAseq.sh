...
#PBS -l select=1:ncpus=10:mem=100gb:scratch_local=250gb:os=debian9
#PBS -j oe
#PBS -N 04v15_alignment_se_ABH8_RNAseq
#
...
OUTPUT_DIR=/storage/brno3-cerit/home/tskalicky/ABH8/mapping/deduplicated/RNAseq
...
APPENDIX="_RNAseq_flexbar.fastq.gz"
