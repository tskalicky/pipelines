...
OUTPUT_DIR=/storage/brno3-cerit/home/tskalicky/Dis3L2/mapping/WT1
...
GENOME_INDEX="/storage/brno3-cerit/home/tskalicky/genomes/human/ensembl91/STAR_index/GRCh38.dna.primary_assembly_RD_LENGTH_79" # Genome index with --sjdbOverhang 79 - Only for Dis3L2. length=125
...
cp -avr $MY_GENOME $MY_GTF $SCRATCHDIR
