...
#
# variables
ABH8_BED="/storage/brno2/home/tskalicky/ABH8/anotace/bed"
...
OUTPUT_DIR="/storage/brno2/home/tskalicky/ABH8/anotace"
ANNOTATION_DB="/storage/brno2/home/tskalicky/genomes/human/annotation/my_annot_DB/ensembl/bed/final2"
####################################################################################################
...
#   	bamToBed -i $FILE | sortBed -i stdin > $FILENAME.bed
#   	date +"%d/%m/%Y %H:%M:%S" 
