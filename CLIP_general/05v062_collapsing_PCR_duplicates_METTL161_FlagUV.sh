...
#PBS -j oe
#PBS -N 05v061_METTL16_FlagUV_Collapsing_PCR_duplicates
#
...
############################################################################################
### Variables
INPUT_DIR="/storage/brno3-cerit/home/tskalicky/METTL16/mapping/deduplicated/METTL16_FlagUV/results/alignment/genome"
...
OUTPUT_DIR="/storage/brno3-cerit/home/tskalicky/METTL16/mapping/deduplicated/METTL16_FlagUV/PCR_collapsed-genome"

MY_RAM=50 # Max RAM memory for Samtools sort
THREADS=$PBS_NUM_PPN
SAMPLES="METTL16_FlagUV"
APPENDIX=".out.bam"
APPENDIX2=".md.sam"
APPENDIX3=".tag.bed"
