...
flexbar -t $TRIMDIR"FlagPAR_SRR6048657_flexbar_qual3" -r FlagPAR_SRR6048657_flexbar_qual2.fastq.gz -q WIN -qf i1.8 -qt 30 -m 17 -n 5 -z GZ &
flexbar -t $TRIMDIR"FlagUV_SRR6048654_flexbar_qual3" -r FlagUV_SRR6048654_flexbar_qual2.fastq.gz -q WIN -qf i1.8 -qt 30 -m 17 -n 5 -z GZ
