...
#PBS -q default
#PBS -l select=1:ncpus=18:mem=200gb:scratch_local=200gb
#PBS -j oe
...
INPUT_ABH8_CLIP="storage-brno9-ceitec.metacentrum.cz:~/ABH8/CLIP/preprocessed/ABH8_*_flexbar3.fastq.gz"
INPUT_ABH8_RNA="storage-brno9-ceitec.metacentrum.cz:~/ABH8/RNA-seq/ABH8_*_clipped_qf.fastq.gz"
OUTPUT_DIR="storage-brno9-ceitec.metacentrum.cz:~/ABH8/preprocessed"
...
scp $INPUT_ABH8_CLIP $INPUT_ABH8_RNA $ADAPTERS $SCRATCHDIR
...
#copy from scratch connected via NFS4
#cp -avr $SCRATCHDIR $OUTPUT_DIR || export CLEAN_SCRATCH=false
#copy from scratch NOT connected via NFS4
