...
#PBS -j oe
#PBS -N 03v7_STAR_index_RDlength100
#
...
GENOME="/storage/brno3-cerit/home/tskalicky/genomes/human/OAT_U12/OAT_U12.fa.gz"
...
GENOME2=${GENOME_NAME%.*}
GTF2=${GTF_NAME%.*}
GEN_DIR="OAT_RNU12_RD_LENGTH_100_STAR2.5.2"
...
--sjdbGTFfile $SCRATCHDIR/$GTF2 --sjdbOverhang $RD_LENGTH --genomeSAindexNbases 8 # --sjdbOverhang 100 should work fine for most of the data, but more specific setting based on the real read length should be more sensitive https://groups.google.com/forum/#!msg/rna-star/h9oh10UlvhI/BfSPGivUHmsJ
