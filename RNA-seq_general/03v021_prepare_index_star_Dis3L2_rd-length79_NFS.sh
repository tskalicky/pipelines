...
#PBS -l select=1:ncpus=8:mem=40gb:scratch_local=80gb:os=debian9
#PBS -j oe
...
############################################################################################
### Variables
# DATADIR="storage-brno3-cerit.metacentrum.cz:~/genomes/human/ensembl91"
# GENOME="storage-brno3-cerit.metacentrum.cz:~/genomes/human/ensembl91/GRCh38.91.dna.primary_assembly.fa.gz"
# GTF="/storage-brno3-cerit.metacentrum.cz:~/genomes/human/ensembl91/GRCh38.91_modif.gtf"
# INDEX_OUTPUT_DIR="storage-brno3-cerit.metacentrum.cz:~/genomes/human/ensembl91/STAR_index"
