...
#PBS -l select=1:ncpus=8:mem=150gb:scratch_local=250gb
#PBS -k oe
#PBS -N alignment_PE_Dis3L2_WT1
#
...
############################################################################################
### Variables
DEDUPL_INPUT="/mnt/storage-brno3-cerit/nfs4/home/tskalicky/Dis3L2/mapping/deduplicated_reads/WT1"
# INPUT_DIR="/storage/brno3-cerit/home/tskalicky/Dis3L2/data/trimmed/WT1"
OUTPUT_DIR="/storage/brno3-cerit/home/tskalicky/Dis3L2/mapping/STAR_genome_tRNA/WT1"
...
GENOME_INDEX="/storage/brno3-cerit/home/tskalicky/genomes/human/ensembl91/STAR_index/GRCh38_with_tRNA_RD_LENGTH_79" # Genome index with --sjdbOverhang 79 - Only for Dis3L2. length=125
...
# RSEM_REF_GENOME="/storage/brno3-cerit/home/tskalicky/genomes/human/ensembl91/RSEM_index/star_align/GRCh38.91.dna.primary_assembly.idx.fa"
MY_GTF="/storage/brno3-cerit/home/tskalicky/genomes/human/ensembl91/GRCh38.91_tRNA_sorted.gtf.gz"
...
find "$DEDUPL_INPUT" -name "*.fastq.gz" -exec cp -vt "$SCRATCHDIR" {} +
...
do
	...
	--outReadsUnmapped Fastx --outSAMunmapped None --outFilterType BySJout --outSAMattributes All \
...
rm $SCRATCHDIR/*.dedupl.fastq.gz # only when the deduplicated reads were created in previous run
