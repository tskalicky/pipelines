...
#PBS -l select=1:ncpus=40:mem=220gb:scratch_local=250gb
#PBS -j oe
#PBS -N alignment_PE_Dis3L2_SpikeIn_KO3
#
...
############################################################################################
### Variables
INPUT_DIR="/storage/brno3-cerit/home/tskalicky/Dis3L2/Dasa_spikein/data/trimmed"
OUTPUT_DIR="/storage/brno3-cerit/home/tskalicky/Dis3L2/Dasa_spikein/mapping/Scerevisiae_genome/not_deduplicated"
...
GENOME_INDEX="/storage/brno3-cerit/home/tskalicky/genomes/Saccharomyces_cerevisiae/STAR_index/Scerevisiae_R64_RD_LENGTH_79" # Genome index with --sjdbOverhang 79 - Only for Dis3L2. length=125
MY_GENOME="/storage/brno3-cerit/home/tskalicky/genomes/Saccharomyces_cerevisiae/Scerevisiae_R64_genomic.fna.gz"
MY_GTF="/storage/brno3-cerit/home/tskalicky/genomes/Saccharomyces_cerevisiae/Scerevisiae_R64_genomic.gff.gz"
...
$SCRATCHDIR/*.dedupl.fastq.gz # only when the deduplicated reads were created in previous run
