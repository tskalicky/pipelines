...
#PBS -j oe
#PBS -N STAR_Dis3L2_SpikeIn_uridil
#
...
############################################################################################
### Variables
INPUT_DIR="/storage/brno3-cerit/home/tskalicky/Dis3L2/Dasa_spikein/uridylation/NEW/trimT"
OUTPUT_DIR="/storage/brno3-cerit/home/tskalicky/Dis3L2/Dasa_spikein/uridylation/mapping_trimmedT"
...
declare -a OAT_cyto=($(find . -maxdepth 1 -name 'trimT_DIS3l2_OAT_cyto*.fastq' -exec basename {} \; | sort -n))
declare -a OAT_nonfrac=($(find . -maxdepth 1 -name 'trimT_DIS3l2_OAT_nonfrac*.fastq' -exec basename {} \; | sort -n))
declare -a OAT_nucl=($(find . -maxdepth 1 -name 'trimT_DIS3l2_OAT_nucl*.fastq' -exec basename {} \; | sort -n))
declare -a U12_cyto=($(find . -maxdepth 1 -name 'trimT_DIS3l2_U12_cyto*.fastq' -exec basename {} \; | sort -n))
declare -a U12_nonfrac=($(find . -maxdepth 1 -name 'trimT_DIS3l2_U12_nonfrac*.fastq' -exec basename {} \; | sort -n))
declare -a U12_nucl=($(find . -maxdepth 1 -name 'trimT_DIS3l2_U12_nucl*.fastq' -exec basename {} \; | sort -n))
