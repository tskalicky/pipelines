...
date +"%d/%m/%Y %H:%M:%S $HOSTNAME"
# samtools view --threads 3 -b -hf 0x2 DIS3l2_OAT_cyto.GRCh38.91Aligned.sortedByCoord.out_mapped.bam > DIS3l2_OAT_cyto.GRCh38.91Aligned.sortedByCoord.out_mapped.sam
# samtools view --threads 3 -hF 4 DIS3l2_OAT_cyto.GRCh38.91Aligned.sortedByCoord.out_mapped.bam > DIS3l2_OAT_cyto.GRCh38.91Aligned.sortedByCoord.out_unique_mapped.sam