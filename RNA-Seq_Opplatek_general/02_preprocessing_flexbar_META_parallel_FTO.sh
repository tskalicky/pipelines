#!/bin/bash
#PBS -l select=1:ncpus=30:mem=30gb:scratch_local=100gb
#PBS -l walltime=96:00:00
#PBS -q uv@wagap-pro.cerit-sc.cz
#PBS -j oe
#PBS -N 02_preprocess_SE_FTO
#
...
### Variables
INPUT_DIR=/storage/brno9-ceitec/home/tskalicky/FTO_project/raw_reads/se_libs
...
do
	...
	flexbar -t $TRIMDIR$SAMPLENAME"_flexbar" -r $READ_FOR -a $ADAPTERS -ac -ao 3 -u 2 -m 17 -n 7 -z GZ -l MOD & 
...
do
	...
	flexbar -t $SAMPLENAME2"2" -r READ_FOR2 -a $ADAPTERS -ac -ae LEFT -ao 3 -u 2 -m 17 -n 7 -z GZ -l MOD &
