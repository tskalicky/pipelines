...
#PBS -j oe
#PBS -N 04_alignment_se_FTO_Input_run
#
...
OUTPUT_DIR=/storage/brno3-cerit/home/tskalicky/FTO/mapping
OUTPUT_DIR=${OUTPUT_DIR}/results
OUTPUT_DIR_QC=${OUTPUT_DIR}/qc

MY_RAM=80 # Max RAM memory for Samtools sort
THREADS=$PBS_NUM_PPN
...
#$MULTIQC -o $SCRATCHDIR/star_gc $SCRATCHDIR/star_gc/ # can't use MultiQC until it is properly installed by META Centrum admins...
####################################################################################################
