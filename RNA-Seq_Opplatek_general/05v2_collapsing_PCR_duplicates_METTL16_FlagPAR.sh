...
#PBS -j oe
#PBS -N 05_METTL16_FlagPAR_Collapsing_PCR_duplicates
#
...
############################################################################################
### Variables
INPUT_DIR=/storage/brno3-cerit/home/tskalicky/METTL16/mapping/FlagPAR/results/alignment/genome
...
OUTPUT_DIR=/storage/brno3-cerit/home/tskalicky/METTL16/mapping/FlagPAR/results/alignment/genome/PCR_collapsed
