...
#PBS -l select=1:ncpus=6:mem=120gb:scratch_local=120gb:os=debian9
#PBS -j oe
#PBS -N 05v3_FTO_CLIP_Collapsing_PCR_duplicates
#
...
############################################################################################
### Variables
INPUT_DIR="/storage/brno3-cerit/home/tskalicky/FTO/mapping/Nmap20_alignments/FTO_CLIP_INPUT_results/alignment/genome"
...
OUTPUT_DIR="/storage/brno3-cerit/home/tskalicky/FTO/mapping/Nmap20_alignments/FTO_CLIP_INPUT_results/alignment/genome/PCR_collapsed"
