...
####################################################################################################
### Variables
OUTPUT_DIR=/storage/brno2/home/opplatek/genomes/human/ensembl87  # Main directory with references and indexes
OUTPUT_DIR=${OUTPUT_DIR}/postQC

GTF=/storage/brno2/home/opplatek/genomes/human/ensembl87/Homo_sapiens.GRCh38.87.gtf.gz # Ensembl annotation (gtf)
GFF_NCBI=/storage/brno2/home/opplatek/genomes/human/GRCh38_latest_genomic.gff.gz # NCBI annotation (gff)
REF_SEQ=/storage/brno2/home/opplatek/genomes/human/ensembl87/Homo_sapiens.GRCh38.dna.primary_assembly.fa.gz # Ensembl genome
