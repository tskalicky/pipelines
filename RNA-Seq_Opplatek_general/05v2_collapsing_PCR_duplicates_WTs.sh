...
#PBS -l select=1:ncpus=3:mem=150gb:scratch_local=250gb:os=debian9
#PBS -j oe
#PBS -N 05_FTO_WTs_Collapsing_PCR_duplicates
#
...
############################################################################################
### Variables
INPUT_DIR=/storage/brno3-cerit/home/tskalicky/FTO/mapping/Nmap20_alignments/WTs/results/alignment/genome/SAM
