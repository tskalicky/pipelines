...
#PBS -l select=1:ncpus=3:mem=200gb:scratch_local=200gb:os=debian9
#PBS -j oe
#PBS -N 05v3_FTO_WTs_Collapsing_PCR_duplicates
#
...
OUTPUT_DIR="/storage/brno3-cerit/home/tskalicky/FTO/mapping/Nmap20_alignments/WTs/PCR_collapsed"
