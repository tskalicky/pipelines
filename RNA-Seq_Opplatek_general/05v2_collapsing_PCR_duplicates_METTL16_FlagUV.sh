...
#PBS -j oe
#PBS -N 05_METTL16_FlagUV_Collapsing_PCR_duplicates
#
...
############################################################################################
### Variables
INPUT_DIR=/storage/brno3-cerit/home/tskalicky/METTL16/mapping/FlagUV/results/alignment/genome
#INPUT_DIR2=/storage/brno3-cerit/home/tskalicky/FTO/mapping/Nmap20_alignments/KO2/results/alignment/genome
#INPUT_DIR3=/storage/brno3-cerit/home/tskalicky/FTO/mapping/Nmap20_alignments/KO3/results/alignment/genome
OUTPUT_DIR=/storage/brno3-cerit/home/tskalicky/METTL16/mapping/FlagUV/results/alignment/genome/PCR_collapsed
...
cp -av $INPUT_DIR/*$APPENDIX $SCRATCHDIR
cd $SCRATCHDIR
...
perl /usr/local/CTK/tag2collapse.pl -v -big --random-barcode -EM 30 --seq-error-model alignment 
-weight --weight-in-name --keep-max-score --keep-tag-name $f.tag.bed $f.tag.uniq.bed
