...
#PBS -j oe
#PBS -N 04_alignment_se_METTL16_UV2_run
#
...
############################################################################################
### Variables
INPUT_DIR=/storage/brno3-cerit/home/tskalicky/METTL16/preprocessed/data/final/METTL16_UV2
OUTPUT_DIR=/storage/brno3-cerit/home/tskalicky/METTL16/mapping/METTL16_UV2
