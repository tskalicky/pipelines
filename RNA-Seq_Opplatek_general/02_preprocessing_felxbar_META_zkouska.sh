...
OUTPUT_DIR=/storage/brno9-ceitec/home/tskalicky/METTL16/preprocessed
...
cp -avr $INPUT_DIR/FlagPAR_* $SCRATCHDIR
cd $SCRATCHDIR
...
fastqc --outdir $QCDIR --format fastq --threads $THREADS $TRIMDIR$SAMPLENAME_flexbar*
