...
#PBS -l select=1:ncpus=3:mem=120gb:scratch_local=250gb:os=debian9
#PBS -j oe
#PBS -N 05_FTO_KO1_Collapsing_PCR_duplicates
#
...
############################################################################################
### Variables
INPUT_DIR=/storage/brno3-cerit/home/tskalicky/FTO/mapping/Nmap20_alignments/WT1/results/alignment/genome
INPUT_DIR2=/storage/brno3-cerit/home/tskalicky/FTO/mapping/Nmap20_alignments/WT2/results/alignment/genome
INPUT_DIR3=/storage/brno3-cerit/home/tskalicky/FTO/mapping/Nmap20_alignments/WT3/results/alignment/genome
OUTPUT_DIR=/storage/brno3-cerit/home/tskalicky/FTO/mapping/Nmap20_alignments/WTs/results/alignment/genome/PCR_collapsed
...
cp -av $INPUT_DIR/*$APPENDIX $INPUT_DIR2/*$APPENDIX $INPUT_DIR3/*$APPENDIX $SCRATCHDIR
cd $SCRATCHDIR
