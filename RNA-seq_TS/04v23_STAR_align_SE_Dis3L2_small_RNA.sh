...
#PBS -l select=1:ncpus=40:mem=1500gb:scratch_local=450gb
#PBS -j oe
#PBS -N STAR_aln_Dis3L2_SpikeIn_all
#
...
OUTPUT_DIR="/storage/brno3-cerit/home/tskalicky/Dis3L2/Nandan_small_RNA_new_set/mapping/STAR_genome"
