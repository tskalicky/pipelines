...
#PBS -l select=1:ncpus=30:mem=200gb:scratch_local=200gb
#PBS -j oe
#PBS -N 03v8_STAR_index_RDlength49
#
...
unpigz -v -p $THREADS $GENOME_NAME
unpigz -v -p $THREADS $GTF_NAME

GENOME2=${GENOME_NAME%.*}
GTF2=${GTF_NAME%.*}
GEN_DIR="GRCh38_RD_LENGTH_49_STAR2.5.2"
