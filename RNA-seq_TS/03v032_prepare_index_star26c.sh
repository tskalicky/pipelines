...
#PBS -l select=1:ncpus=30:mem=200gb:scratch_local=100gb
#PBS -j oe
#PBS -N 03v3_STAR_index_RDlength100
#
...
############################################################################################
### Variables
set +f # enable globbing, because is needed for variable expansions !!!
#
...
# Adding RSEM and STAR v2.6.0c binaries into the PATH
...
#
# Binaries
RSEM_PREP=$(which rsem-prepare-reference)
STAR=$(which STAR)
...
GEN_DIR="GRCh38_with_RD_LENGTH_100_STAR2.6c"
