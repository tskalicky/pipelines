...
### Variables
INPUT_D3L2_SpikeIn="/storage/brno3-cerit/home/tskalicky/Dis3L2/Dasa_spikein/RAW"
SEMI_TRIM="/storage/brno3-cerit/home/tskalicky/Dis3L2/Dasa_spikein/data/semi_trimmed"
OUTPUT_DIR="/storage/brno3-cerit/home/tskalicky/Dis3L2/Dasa_spikein/data/"
#
...
cp -av $SEMI_TRIM/*.fastq.gz $ADAPTERS $SCRATCHDIR
#
cd $SCRATCHDIR
#
...
# flexbar -t $TRIMDIR"DIS3l2_U12_cyto_flexbar" -r DIS3l2_U12_cyto_R1.fastq.gz -p DIS3l2_U12_cyto_R2.fastq.gz -q TAIL -qf i1.8 -qt 30 --qtrim-post-removal -a $SCRATCHDIR"/adapters_v4.fa" -ac -ae ANY -ao 3 -u 2 -m 17 -n 4 -z GZ &
# flexbar -t $TRIMDIR"DIS3l2_OAT_nucl_flexbar" -r DIS3l2_OAT_nucl_R1.fastq.gz -p DIS3l2_OAT_nucl_R2.fastq.gz -q TAIL -qf i1.8 -qt 30 --qtrim-post-removal -a $SCRATCHDIR"/adapters_v4.fa" -ac -ae ANY -ao 3 -u 2 -m 17 -n 4 -z GZ &
# flexbar -t $TRIMDIR"DIS3l2_OAT_nonfrac_flexbar" -r DIS3l2_OAT_nonfrac_R1.fastq.gz -p DIS3l2_OAT_nonfrac_R2.fastq.gz -q TAIL -qf i1.8 -qt 30 --qtrim-post-removal -a $SCRATCHDIR"/adapters_v4.fa" -ac -ae ANY -ao 3 -u 2 -m 17 -n 4 -z GZ &
# flexbar -t $TRIMDIR"DIS3l2_OAT_cyto_flexbar" -r DIS3l2_OAT_cyto_R1.fastq.gz -p DIS3l2_OAT_cyto_R2.fastq.gz -q TAIL -qf i1.8 -qt 30 --qtrim-post-removal -a $SCRATCHDIR"/adapters_v4.fa" -ac -ae ANY -ao 3 -u 2 -m 17 -n 4 -z GZ
#
# Potreba znovu otrimovat na kvalitu. Z nejakeho duvodu to nefungovalo.
flexbar -t $TRIMDIR"DIS3l2_U12_nucl_flexbar" -r DIS3l2_U12_nucl_R1_flexbar.fastq.gz -p DIS3l2_U12_nucl_R2_flexbar.fastq.gz -q TAIL -qf i1.8 -qt 30 -m 17 -n 2 -z GZ &
flexbar -t $TRIMDIR"DIS3l2_U12_nonfrac_flexbar" -r DIS3l2_U12_nonfrac_R1_flexbar.fastq.gz -p DIS3l2_U12_nonfrac_R2_flexbar.fastq.gz -q TAIL -qf i1.8 -qt 30 -m 17 -n 2 -z GZ &
flexbar -t $TRIMDIR"DIS3l2_U12_cyto_flexbar" -r DIS3l2_U12_cyto_R1_flexbar.fastq.gz -p DIS3l2_U12_cyto_R2_flexbar.fastq.gz -q TAIL -qf i1.8 -qt 30 -m 17 -n 2 -z GZ &
flexbar -t $TRIMDIR"DIS3l2_OAT_nucl_flexbar" -r DIS3l2_OAT_nucl_R1_flexbar.fastq.gz -p DIS3l2_OAT_nucl_R2_flexbar.fastq.gz -q TAIL -qf i1.8 -qt 30 -m 17 -n 2 -z GZ &
flexbar -t $TRIMDIR"DIS3l2_OAT_nonfrac_flexbar" -r DIS3l2_OAT_nonfrac_R1_flexbar.fastq.gz -p DIS3l2_OAT_nonfrac_R2_flexbar.fastq.gz -q TAIL -qf i1.8 -qt 30 -m 17 -n 2 -z GZ &
flexbar -t $TRIMDIR"DIS3l2_OAT_cyto_flexbar" -r DIS3l2_OAT_cyto_R1_flexbar.fastq.gz -p DIS3l2_OAT_cyto_R2_flexbar.fastq.gz -q TAIL -qf i1.8 -qt 30 -m 17 -n 2 -z GZ
#
