...
############################################################################################
### Variables
OUTPUT_DIR="/storage/brno3-cerit/home/tskalicky/Dis3L2/Dasa_spikein/new_upscale/data/RAW"
INPUT="/storage/brno3-cerit/home/tskalicky/Dis3L2/Dasa_spikein/new_upscale/data/RAW"
...
do
	...
	java -Xmx50g -jar $PICARD SamToFastq INPUT=$FILE FASTQ="$FILENAME"_R1.fastq SECOND_END_FASTQ="$FILENAME"_R2.fastq
	date +"%d/%m/%Y %H:%M:%S"
