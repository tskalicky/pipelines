...
#PBS -l select=1:ncpus=8:mem=200gb:scratch_local=250gb
#PBS -j oe
#PBS -N STAR_aln_PE_Dis3L2_WT1
#
...
############################################################################################
### Variables
DEDUPL_INPUT="/storage/brno3-cerit/home/tskalicky/Dis3L2/data/trimmed/WT1"
...
OUTPUT_DIR=${OUTPUT_DIR}/WT1_results
...
export PATH="/storage/brno3-cerit/home/tskalicky/tools/ucsc:$PATH"
...
cp -av $DEDUPL_INPUT/*.fastq.gz $SCRATCHDIR
cd $SCRATCHDIR
...
ls -Rc1
echo "Following files were copied to scratch:" >> /storage/brno3-cerit/home/tskalicky/Dis3L2/mapping/STAR_genome/log.txt #Debugging
ls -Rc1 >> /storage/brno3-cerit/home/tskalicky/Dis3L2/mapping/STAR_genome/log.txt #Debugging
####################################################################################################
...
do
	...
	--readFilesIn $READ_FOR $READ_REV --readFilesCommand gunzip -c  \
	--sjdbOverhang $RD_LENGTH --sjdbGTFfile $GTF \
	--outFileNamePrefix ${i%"_flexbar_"*}.${GTF%.*} \
